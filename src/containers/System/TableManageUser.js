            ...
            <React.Fragment>
                <div className="users-container">
                    <div className="users-table mt-3 mx-1">
                        <div className="title text-center"><FormattedMessage id="menu.admin.user-list" /></div>
                                ...
                                {arrUsers && arrUsers.length > 0 && arrUsers.map((item, index) => {
                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td>{item.address}</td>
                                            <td>{
                                                item.roleId == 'R1' && <FormattedMessage id="create-user.admin"/> ||
                                                item.roleId == 'R2'  && <FormattedMessage id="create-user.doctor"/> ||
                                                item.roleId == 'R3'  && <FormattedMessage id="create-user.patient"/>
                                            }
                                            </td>
                                            <td>
