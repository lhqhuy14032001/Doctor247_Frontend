...
class ManageSpecialty extends Component {
    ...
    checkValidateInput = () => {
        ...
        for (let i = 0; i < arrCheck.length; i++) {
            if (!this.state[arrCheck[i]]) {
                ...
                let paramsMissing = arrCheck[i];
                toast.error(`${paramsMissing.toUpperCase()} is required`);
                break;
            }
        }
        return isValid;
    ...
    render() {
        ...
        return (
            ...
            <div className="user-redux-container bg-light " >
                <div className="title m-0 py-2">
                ...
                <div className="user-redux-body">
                    <div className="container">
                        ...
                        <div className="col-12 my-3">
                            <button className={this.state.action === CRUD_ACTIONS.EDIT ? "btn btn-warning px-2" : "btn btn-primary px-2"} type="submit"
