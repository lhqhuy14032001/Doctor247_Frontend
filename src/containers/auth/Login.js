        ...
        <div className="login-container">
          <div className="login-content row">
            ...
            <div className="col-12 login-input">
              <button className="btn btn-info btn-login" onClick={() => { this.handleLogin() }}>Login</button>
            </div>
            <div className="col-12">
              <span className="sign-up">Or</span>
            </div>
            <div className="col-12 login-input">
              <button className="btn btn-info btn-login" onClick={() => { this.handleAddNewUser() }}>Register</button>
            </div>
            {/* <div className="col-12">
