...
class ManageSchedule extends Component {
    ...
    handleSaveSchedule = async () => {
        ...
        let doctorId = this.props.userLogin.id
        let result = [];
        if (!currentDate) {
    ...
    render() {
        ...
        // console.log('check doctor', this.props.userLogin)
                ...
                <div className="container">
                    <div className="row">
                                ...
                                rangeTime.map((item, index) => {
                                    return (
                                        <button className={item.isSelected === true ?
                                            "btn btn-schedule active px-2" : "btn btn-schedule px-2"}
                        ...
                        <div className="col-12">
                            <button className="btn btn-primary btn-save-schedule px-2"
