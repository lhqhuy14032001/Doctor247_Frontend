...
class HomeHeader extends Component {
    ...
    render() {
        ...
        // let name = language === LANGUAGES.VI ? `${userInfo.lastName} && ${userInfo.firstName}` : `${userInfo.firstName} && ${userInfo.lastName}`
        return (
            <React.Fragment>
                ...
                <div className={isShowBanner ? 'banner' : 'banner d-none'} >
                    <div className='banner-title'>
                        <h1>
                            <FormattedMessage id="banner.medical-platform" /><br />
                            <b><FormattedMessage id="banner.take-care" /></b>
                        </h1>
                    </div>
                    <div className='banner-services'>
                        <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2021/12/08/133537-khamchuyenkhoa.png' alt='service-icon' />
                            </div>
                            <p className='service-title'><FormattedMessage id="banner.speciality_check-up" /></p>
                        </div> <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2021/12/08/133657-khamtuxa.png' alt='service-icon' />
                            </div>
                            <p className='service-title'><FormattedMessage id="banner.remote_check-up" /></p>
                        </div> <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2021/12/08/133744-khamtongquat.png' alt='service-icon' />
                            </div>
                            <p className='service-title'><FormattedMessage id="banner.general_check-up" /></p>
                        </div> <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2021/12/08/133537-khamchuyenkhoa.png' alt='service-icon' />
                            </div>
                            <p className='service-title'><FormattedMessage id="banner.medical-test" /></p>
                        </div> <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2021/12/08/133744-suckhoetinhthan.png' alt='service-icon' />
                            </div>
                            <p className='service-title'><FormattedMessage id="banner.mental-health" /></p>
                        </div> <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2022/05/19/104635-khamnhakhoa.png' alt='service-icon' />
                            </div>
                            <p className='service-title'><FormattedMessage id="banner.dental_check-up" /></p>
                        </div> <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2022/05/16/151930-phau-thuat.jpg' alt='service-icon' />
                            </div>
                            <p className='service-title'><FormattedMessage id="banner.surgery-package" /></p>
                        </div> <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2021/12/08/133744-khamtainha.png' alt='service-icon' />
                            </div>
                            <p className='service-title'><FormattedMessage id="banner.medical-product" /></p>
                        </div>
                        <div className='services-child'>
                            <div className='service-icon'>
                                <img src='https://cdn.bookingcare.vn/fo/2021/12/08/133744-khamtainha.png' alt='service-icon' />
